...
export const contentApi = {
     ...
     * Get movies list
     */
    getMovies: async (page = 1, limit = 20, genreId, language = "en") => {
        const params = new URLSearchParams({
            page: page.toString(),
            limit: limit.toString(),
            ...(genreId && { genreId }),
        });
        return apiRequest(`/content/movies?${params}`, { language });
    },

    /**
     * Get movie details
     */
    getMovieDetail: async (id, language = "en") => {
     ...
     * Get shows list
     */
    getShows: async (page = 1, limit = 20, genreId, language = "en") => {
        const params = new URLSearchParams({
            page: page.toString(),
            limit: limit.toString(),
            ...(genreId && { genreId }),
        });
        return apiRequest(`/content/shows?${params}`, { language });
    },

    /**
     * Get show details with seasons
     */
    getShowDetail: async (id, language = "en") => {
...
export const searchApi = {
     ...
     * Search content
     */
    search: async (query, contentType = "all", language = "en") => {
        const params = new URLSearchParams({
            query,
            contentType,
        });
...
export const watchlistApi = {
     ...
     */
    getWatchlist: async (page = 1, limit = 20, status) => {
        const params = new URLSearchParams({
            page: page.toString(),
            limit: limit.toString(),
            ...(status && { status }),
     ...
     */
    updateWatchlistItem: async (id, status, watchedProgress) => {
...
export const articlesApi = {
     ...
     * Get article details
     */
    getArticleDetail: async (slug, language = "en") => {
