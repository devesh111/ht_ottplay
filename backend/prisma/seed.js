...
async function main() {
    ...
    const show1 = await prisma.show.create({
        data: {
            ...
            description_ar:
                "يتحول معلم الكيمياء بالمدرسة الثانوية إلى طهي الميثامفيتامين",
    ...
    await prisma.episode.create({
        data: {
            ...
            description_en:
                "A high school chemistry teacher is diagnosed with cancer",
            description_ar:
                "يتم تشخيص معلم الكيمياء بالمدرسة الثانوية بالسرطان",
            duration: 58,
            releaseDate: new Date("2008-01-20"),
        },
    });
